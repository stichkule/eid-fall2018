# -*- coding: utf-8 -*-
"""
Python code to implement the temperature and relative humidity monitoring application for Project 2 of ECEN 5053.
...
file as strings, which is then accessed by the server.py script that serves client requests.
