...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_Fetch.setGeometry(QtCore.QRect(610, 400, 101, 31))
        self.pushButton_Fetch.setObjectName("pushButton_Fetch")
        self.pushButton_Protocol_Test = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_Protocol_Test.setGeometry(QtCore.QRect(610, 470, 101, 31))
        self.pushButton_Protocol_Test.setObjectName("pushButton_Protocol_Test")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "ECEN_5053 -- Project_3 -- Temp/RH Client"))
        ...
        self.pushButton_Protocol_Test.setText(_translate("MainWindow", "Protocol Test"))
